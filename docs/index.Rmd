...
Subsequently, I bind all the separate adjacency matrices together to create a combined adjacency matrix. And, based on the matrix results, I calculate the structural equivalence of nodes.
...
From the resulting matrix of structural equivalences, I create a series of dendrograms, each with a different number of clusters (from 2 to 5). Put differently, using dendrograms, I identify between 2 and 5 groups of structurally equivalent nodes.
